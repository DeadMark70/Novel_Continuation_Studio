...
4. **High Code Coverage:** Prioritize high coverage on changed/high-risk modules and keep critical-path tests green
...
- [ ] Type safety is strictly enforced (No 'any' types allowed; execute `tsc --noEmit`)
- [ ] No linting or static analysis errors (using `npm run lint`)
