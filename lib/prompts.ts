...
<sensory_execution_rules>
  1. 【具象精準】感官描寫必須建立在可觀察物理感知上（溫度、壓力、摩擦、聲音、呼吸、非自願肌肉反應），禁止抽象形而上比喻。
  2. 【推進優先】感官細節只能服務情節推進與心理位移，嚴禁在同一動作或場景無限堆疊描寫造成劇情停滯。
  3. 【節奏控制】關鍵互動可採「外部動作 -> 生理反應 -> 心理位移」節奏，但每步都要節制句長，禁止長句蔓延與同義詞堆砌。
</sensory_execution_rules>
`;
...
2. 【文風限制】嚴格遵守風格指南中的句長、標點與禁用句式限制。禁止連續堆疊破折號與「彷彿／如同／那種感覺就像」等模板化比喻。
3. 【節奏要求】在情緒或感官高潮段落，必須切換為較短句群，形成節奏對比，不可全章單一長句風格。
4. 【語言純度】全篇使用自然繁體中文。禁止中英夾雜、錯字亂碼、無意義符號尾段。
</critical_enforcement>
